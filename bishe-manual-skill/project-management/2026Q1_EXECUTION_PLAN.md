# 2026Q1 Execution Plan - bishe-manual-skill
...
| #3 | Core-1 | type:feature, priority:P1, area:core | M1(1-3月) | 2026-01 |
| #4 | Core-2 | type:feature, priority:P1, area:core | M1(1-3月) | 2026-01 |
| #5 | Core-3 | type:feature, priority:P2, area:core | M1(1-3月) | 2026-01 |
| #6 | Fix-1 | type:bug, priority:P1, area:bugfix | M1(1-3月) | 2026-01 |
| #7 | Test-1 | type:test, priority:P2, area:qa | M1(1-3月) | 2026-01 |
| #8 | Docs-1 | type:docs, priority:P3, area:docs-deploy | M1(1-3月) | 2026-01 |

## PR Rhythm
- PR-1 (Initialization): Closes #1 #2
- PR-2 (Core Features): Closes #3 #4 #5
- PR-3 (Stabilization): Closes #6 #7 #8
